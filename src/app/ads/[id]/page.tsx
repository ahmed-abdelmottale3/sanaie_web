      ...
      <>
        ...
        <div className="flex min-h-[400px] items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Ad not found</h2>
            <Link href="/ads" className="text-red-600 hover:text-red-700">
              Go back to Ads
            </Link>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-12 bg-slate-50">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <Link
              href="/ads"
              className="inline-flex items-center gap-2 mb-6 text-slate-600 hover:text-slate-900 transition-colors"
            >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    <div className="rounded-lg bg-slate-50 p-4">
                      ...
                      <p className="text-lg font-bold text-slate-900">{ad.targetUserType}</p>
                    </div>

                    <div className="rounded-lg bg-slate-50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Calendar className="h-5 w-5 text-slate-600" />
                        <span className="text-sm font-semibold text-slate-600">Campaign Period</span>
                      </div>
                    ...
                    <div className="rounded-lg bg-slate-50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-slate-600">Total Views</span>
                      </div>
                      <p className="text-2xl font-bold text-slate-900">{ad.views.toLocaleString()}</p>
                    </div>

                    <div className="rounded-lg bg-slate-50 p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <MousePointerClick className="h-5 w-5 text-slate-600" />
                        <span className="text-sm font-semibold text-slate-600">Total Clicks</span>
                      </div>
                      <p className="text-2xl font-bold text-slate-900">{ad.clicks.toLocaleString()}</p>
                    </div>
                  </div>
                  ...
                  <div className="border-t border-slate-200 pt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="text-center p-4 rounded-lg bg-red-50">
                        <div className="text-sm font-semibold text-slate-600 mb-1">Click-Through Rate</div>
                        <div className="text-2xl font-bold text-red-600">
                          {ad.views > 0 ? ((ad.clicks / ad.views) * 100).toFixed(2) : 0}%
                        </div>
                      </div>
                      <div className="text-center p-4 rounded-lg bg-blue-50">
                        <div className="text-sm font-semibold text-slate-600 mb-1">Average Views</div>
                        <div className="text-2xl font-bold text-blue-600">{ad.views.toLocaleString()}</div>
                      </div>
                      <div className="text-center p-4 rounded-lg bg-green-50">
                        <div className="text-sm font-semibold text-slate-600 mb-1">Engagement</div>

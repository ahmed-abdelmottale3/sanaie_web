    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <PageHero
          ...
          description="Track ad performance, engagement rates, and campaign effectiveness"
        />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h3 className="mb-4 text-lg font-bold text-slate-900">Ad Status Distribution</h3>
                <PieChart data={chartData} height={300} />
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                <h3 className="mb-4 text-lg font-bold text-slate-900">Engagement Metrics</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between rounded-lg bg-slate-50 p-4">
                    <span className="text-sm font-semibold text-slate-600">Average Clicks per Ad</span>
                    <span className="text-xl font-bold text-slate-900">{stats.averageClicks.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-slate-50 p-4">
                    <span className="text-sm font-semibold text-slate-600">Average Views per Ad</span>
                    <span className="text-xl font-bold text-slate-900">{stats.averageViews.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-slate-50 p-4">
                    <span className="text-sm font-semibold text-slate-600">Click-Through Rate (CTR)</span>
                    <span className="text-xl font-bold text-slate-900">{clickThroughRate}%</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg bg-slate-50 p-4">
                    <span className="text-sm font-semibold text-slate-600">Total Engagement</span>
            ...
            {/* Ads Display Section */}
            <div className="mt-12">
              <h2 className="text-2xl font-extrabold text-slate-900 mb-6">All Advertisements</h2>
                ...
                <>
                  {ads.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-lg font-semibold text-slate-600">No ads found</p>
                    </div>
                  ) : (
                            ...
                            <div className="p-4">
                              ...
                              <div className="space-y-2 mb-4">
                                <div className="flex items-center gap-2 text-xs text-slate-500">
                                  ...
                                  <span>Target: {ad.targetUserType}</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs text-slate-500">
